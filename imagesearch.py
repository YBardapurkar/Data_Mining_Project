...
class ImageSearch:
	...
	def __init__(self):
		self.data = self.load_data('img_captions.csv').fillna('')
	...
	def load_data(self, path):
		...
		return dataframe[['id', 'url', 'caption']]
	...
	def init(self):
		...
		file_unique_tokens = open('imagecaption_file_unique_tokens.pkl', 'rb')
		file_postings = open('imagecaption_file_postings.pkl', 'rb')
		file_document_frequency = open('imagecaption_file_document_frequency.pkl', 'rb')
		file_lengths = open('imagecaption_file_lengths.pkl', 'rb')
		# ^
		...
		for index, row in self.data.iterrows():
			...
			for term in set(tokens):
				...
				self.postings[term][image_id] = tokens.count(term)
			...
			# add to doc lengths
			self.lengths[image_id] = len(tokens)
		...
		# file_unique_tokens = open('imagecaption_file_unique_tokens.pkl', 'wb')
		# file_postings = open('imagecaption_file_postings.pkl', 'wb')
		# file_document_frequency = open('imagecaption_file_document_frequency.pkl', 'wb')
		# file_lengths = open('imagecaption_file_lengths.pkl', 'wb')
	...
	def query_image(self, query_string):
